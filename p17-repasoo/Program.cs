...
namespace p17_repasoo
{
    class Program
    {
        ...
        {
            //inicialisar datos
            Red mired = new Red("Universidad Autonoma de Zacatecas","Ruben ibarra Reyes","Jardin juares 147");
            mired.AgregarNodo(new Nodo("192.168.0.10","servidor",5,10,"linux"));
            mired.AgregarNodo(new Nodo("192.168.0.12","aquipoactivo",2,12,"ios"));
            mired.AgregarNodo(new Nodo("192.168.0.20","servidor",8,5,"windows"));
