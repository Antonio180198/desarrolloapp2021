...
namespace p15_controlbancario
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            mibanco.AgregarCliente(new Cliente("juan","perez"));
            mibanco.AgregarCliente(new Cliente("rene","perez"));
            mibanco.AgregarCliente(new Cliente("sodel","perez"));
            ...
            mibanco.clientes[0].AgregarCuenta(new CuentaDeAhorro(6500,500));
            mibanco.clientes[1].AgregarCuenta(new CuentaDeAhorro(2500,500));
            mibanco.clientes[2].AgregarCuenta(new CuentaDeAhorro(16500,1500));
            ...
            foreach (Cliente cte in mibanco.clientes){
                Console.WriteLine($"\nCliente : {cte.nombre}, {cte.apeido}, Cuenteas: {cte.cuentas.Count}");
